...
// helper component to display value of current and show 
...
// helper function to render Selector inside of CardProvider
...
describe('when there are cards, the sidebar has a menu item for each subject', () => {
  ...
  (number) => {
    ...
    // render selector with the state with the subjectds
