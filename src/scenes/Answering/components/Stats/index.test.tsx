...
import {StatsProvider} from '../../../../services/StatsContext/index';
...
describe('theres a popup', () => {
  ...
  it('popup exists and opens', () => {
    ...
    // test will output a warning. 
    // TODO: follow the link below to remove the warning:
  ...
  describe('with Stats', () => {
    ...
    it('with stats, show stats for that question', () => {
