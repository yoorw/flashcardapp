...
import {loadCards, loadStats, saveCards, saveStats} from './index';
...
describe('Saving and Loading Cards', () => {
  ...
  it('Loading cards when no saved cards exist returns undefined', () => {
...
describe('Saving and Loading Stats', () => {
  ...
  it('Saving stats saves stats', () => {
    ...
    expect(setItem).toHaveBeenLastCalledWith('stats', stringStats);
  });
